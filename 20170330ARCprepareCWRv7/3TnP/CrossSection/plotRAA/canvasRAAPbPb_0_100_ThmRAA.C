...
//=========  (Wed Mar 29 20:50:39 2017) by ROOT version6.02/10
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.274052);
   Graph_gNuclearModification3002->SetMaximum(0.683018);
   ...
   Graph_gNuclearModification_Cor3003->SetMinimum(0.2425934);
   Graph_gNuclearModification_Cor3003->SetMaximum(0.764958);
