...
//RAA Rapidity
TFile* ppMCEfffileY = new TFile("ROOTfiles/MCstudiesPP_Y.root");
TH1D* ppEffY = (TH1D*)ppMCEfffileY->Get("hEff");
TFile* PbPbMCEfffileY = new TFile("ROOTfiles/MCstudiesPbPb_Y.root");
TH1D* PbPbEffY = (TH1D*)PbPbMCEfffileY->Get("hEff");

//RAA Centrality
TH1D*  TAAUncertainty;
TFile* ppMCEfffileCent = new TFile("ROOTfiles/MCstudiesPP_INC.root");
TH1D* ppEffCent = (TH1D*)ppMCEfffileCent->Get("hEff");
TFile* PbPbMCEfffileCent = new TFile("ROOTfiles/MCstudiesPbPb_CENT.root");
...
//	PbPbSignalExtraction->SetBinContent(1,		8.7);//PAS
