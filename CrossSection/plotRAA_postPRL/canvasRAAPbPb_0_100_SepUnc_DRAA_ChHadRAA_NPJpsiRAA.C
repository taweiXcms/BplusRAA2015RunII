...
//=========  (Thu Dec 13 15:29:07 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification_UnCor3003->SetMinimum(0.2738738);
   Graph_gNuclearModification_UnCor3003->SetMaximum(0.6839795);
   ...
   Graph_gNuclearModification_Cor3004->SetMinimum(0.2502459);
   Graph_gNuclearModification_Cor3004->SetMaximum(0.7526422);
   ...
   hNuclearModification5->SetBinContent(1,0.3458558);
   hNuclearModification5->SetBinContent(2,0.4480066);
   hNuclearModification5->SetBinContent(3,0.4402087);
   hNuclearModification5->SetBinContent(4,0.615181);
   hNuclearModification5->SetBinContent(5,0.3486562);
   hNuclearModification5->SetBinError(1,0.1086955);
   hNuclearModification5->SetBinError(2,0.07447295);
   hNuclearModification5->SetBinError(3,0.07507186);
   hNuclearModification5->SetBinError(4,0.09192405);
   hNuclearModification5->SetBinError(5,0.1120147);
   hNuclearModification5->SetEntries(109.8058);
   ...
   hNuclearModification9->SetBinContent(1,0.3458558);
   hNuclearModification9->SetBinContent(2,0.4480066);
   hNuclearModification9->SetBinContent(3,0.4402087);
   hNuclearModification9->SetBinContent(4,0.615181);
   hNuclearModification9->SetBinContent(5,0.3486562);
   hNuclearModification9->SetBinError(1,0.1086955);
   hNuclearModification9->SetBinError(2,0.07447295);
   hNuclearModification9->SetBinError(3,0.07507186);
   hNuclearModification9->SetBinError(4,0.09192405);
   hNuclearModification9->SetBinError(5,0.1120147);
   hNuclearModification9->SetEntries(109.8058);
