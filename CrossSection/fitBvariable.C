...
int main(int argc, char *argv[])
{
  if(argc==17)
    {
      fitBvariable(argv[1], argv[2],atoi(argv[3]),argv[4], argv[5], argv[6], argv[7], argv[8], atoi(argv[9]), atof(argv[10]), atoi(argv[11]),argv[12],argv[13],argv[14],atof(argv[15]),atof(argv[16]));
      return 0;
    }
  else if(argc==15)
    {
      fitBvariable(argv[1], argv[2],atoi(argv[3]),argv[4], argv[5], argv[6], argv[7], argv[8], atoi(argv[9]), atof(argv[10]), atoi(argv[11]),argv[12],argv[13],argv[14]);
      return 0;
    }
  else
    {
