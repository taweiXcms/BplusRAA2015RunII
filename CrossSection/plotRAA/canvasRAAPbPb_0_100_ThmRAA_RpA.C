...
//=========  (Tue Feb 28 07:59:16 2017) by ROOT version6.02/10
   ...
   canvasRAA->Range(0.5094515,-0.447205,2.088772,3.279503);
   ...
   TH2F *hemptyEff1 = new TH2F("hemptyEff1","",50,5,110,10,0,3);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.23,0.7,"T_{AA} + lumi.");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.23,0.66,"uncertainty");
tex->SetNDC();
   tex->SetTextFont(42);
   ...
   TH2F *hemptyEff_copy4 = new TH2F("hemptyEff_copy4","",50,5,110,10,0,3);
