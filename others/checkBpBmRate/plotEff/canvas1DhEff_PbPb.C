...
//=========  (Sun Feb 26 04:59:14 2017) by ROOT version6.02/10
   ...
   hEff2->SetBinContent(2,0.02356693);
   hEff2->SetBinContent(3,0.07009033);
   hEff2->SetBinContent(4,0.1319915);
   hEff2->SetBinContent(5,0.1848635);
   hEff2->SetBinError(2,0.001253384);
   hEff2->SetBinError(3,0.003492305);
   hEff2->SetBinError(4,0.00438859);
   hEff2->SetBinError(5,0.005328768);
   hEff2->SetEntries(2743.619);
   hEff2->SetStats(0);
