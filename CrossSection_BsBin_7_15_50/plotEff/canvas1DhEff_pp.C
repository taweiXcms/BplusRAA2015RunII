...
//=========  (Tue Apr 17 01:05:01 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.03647536);
   hEff2->SetBinContent(2,0.2186648);
   hEff2->SetBinError(1,0.0003711689);
   hEff2->SetBinError(2,0.001531026);
   hEff2->SetEntries(26229.47);
   hEff2->SetStats(0);
