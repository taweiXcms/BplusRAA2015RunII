...
//=========  (Tue Apr 17 01:06:41 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.0105339);
   hEff2->SetBinContent(2,0.09847259);
   hEff2->SetBinError(1,0.0003481559);
   hEff2->SetBinError(2,0.001811209);
   hEff2->SetEntries(3493.09);
   hEff2->SetStats(0);
