...
//=========  (Wed Dec 13 18:02:24 2017) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.002350305);
   hEff2->SetBinContent(1,0.107817);
   hEff2->SetBinError(0,7.994528e-05);
   hEff2->SetBinError(1,0.001830585);
   hEff2->SetEntries(3468.925);
   hEff2->SetStats(0);
