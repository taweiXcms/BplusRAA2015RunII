...
//=========  (Mon Dec  5 22:12:40 2016) by ROOT version6.02/10
   ...
   hemptyEff1->Draw("");
   Double_t xAxis1[2] = {10, 50}; 
   
   TH1D *hEff2 = new TH1D("hEff2","",1, xAxis1);
   hEff2->SetBinContent(0,0.002135184);
   hEff2->SetBinContent(1,0.1172248);
   hEff2->SetBinError(0,4.691044e-05);
   hEff2->SetBinError(1,0.0007914732);
   hEff2->SetEntries(21936.47);
   hEff2->SetStats(0);
