...
//=========  (Mon Dec  5 22:00:11 2016) by ROOT version6.02/10
   ...
   hEff2->SetBinContent(1,0.263038);
   hEff2->SetBinContent(2,0.2802485);
   hEff2->SetBinContent(3,0.3201892);
   hEff2->SetBinContent(4,0.2311851);
   hEff2->SetBinError(1,0.003181826);
   hEff2->SetBinError(2,0.003586415);
   hEff2->SetBinError(3,0.004095169);
   hEff2->SetBinError(4,0.002620678);
   hEff2->SetEntries(25700.57);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.75,"10 < p_{T} < 50 (GeV/c)");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
