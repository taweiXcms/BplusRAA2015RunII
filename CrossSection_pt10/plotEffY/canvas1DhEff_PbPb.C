...
//=========  (Mon Dec  5 22:01:50 2016) by ROOT version6.02/10
   ...
   hEff2->SetBinContent(1,0.1165591);
   hEff2->SetBinContent(2,0.1100843);
   hEff2->SetBinContent(3,0.1198673);
   hEff2->SetBinContent(4,0.0714149);
   hEff2->SetBinError(1,0.003511303);
   hEff2->SetBinError(2,0.003545035);
   hEff2->SetBinError(3,0.003949284);
   hEff2->SetBinError(4,0.002681284);
   hEff2->SetEntries(3663.004);
   hEff2->SetStats(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.5,0.75,"10 < p_{T} < 50 (GeV/c)");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
