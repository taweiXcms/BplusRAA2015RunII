...
//=========  (Wed Mar 29 00:19:47 2017) by ROOT version6.02/10
...
tex->SetNDC();
   ...
   Graph_gNuclearModification_Cor3003->SetMinimum(0.2518284);
   Graph_gNuclearModification_Cor3003->SetMaximum(0.7500953);
