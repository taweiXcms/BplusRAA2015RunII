...
//=========  (Wed Dec 13 17:55:59 2017) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.007722016);
   hEff2->SetBinContent(1,0.2361235);
   hEff2->SetBinError(0,8.333117e-05);
   hEff2->SetBinError(1,0.001582665);
   hEff2->SetEntries(22258.73);
   hEff2->SetStats(0);
