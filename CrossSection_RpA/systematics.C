...
double PtBins[nPtBins+1] = {10.,60.};// pp 10~60
const int AnaBins=5;
//double AnaPtBins[AnaBins+1] = {7.,10.,15.,20.,30.,50.};// pp 7~50
double AnaPtBins[AnaBins+1] = {10.,15.,20.,25.,30.,60.};// pp 10~60
...
//   double tnpUnc_pp[5] = {5.386053, 3.814706, 3.235419, 3.014523, 2.819569, };// pp 7~50
   double tnpUnc_pp[5] = {3.814706, 3.235419, 3.062123, 2.925012, 2.819569, };// pp 10~60
