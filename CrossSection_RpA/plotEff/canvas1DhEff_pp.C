...
//=========  (Mon Feb 27 23:55:47 2017) by ROOT version6.02/10
   ...
   TH2F *hemptyEff1 = new TH2F("hemptyEff1","",50,5,65,10,0,0.6);
   ...
   hEff2->SetBinContent(0,0.002135184);
   hEff2->SetBinContent(1,0.07791027);
   hEff2->SetBinContent(2,0.1833023);
   hEff2->SetBinContent(3,0.2497474);
   hEff2->SetBinContent(4,0.3002727);
   hEff2->SetBinContent(5,0.327901);
   hEff2->SetBinError(0,4.691044e-05);
   hEff2->SetBinError(1,0.0008953238);
   hEff2->SetBinError(2,0.002102475);
   hEff2->SetBinError(3,0.00303489);
   hEff2->SetBinError(4,0.003598981);
   hEff2->SetBinError(5,0.00266616);
   hEff2->SetEntries(37619.27);
   hEff2->SetStats(0);
