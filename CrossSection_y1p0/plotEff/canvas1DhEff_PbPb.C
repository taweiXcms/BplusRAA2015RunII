...
//=========  (Sun Nov 20 10:05:54 2016) by ROOT version6.02/10
   ...
   hEff2->SetBinContent(1,0.002683806);
   hEff2->SetBinContent(2,0.02346476);
   hEff2->SetBinContent(3,0.08332583);
   hEff2->SetBinContent(4,0.1624456);
   hEff2->SetBinContent(5,0.2494101);
   hEff2->SetBinError(1,0.0003357421);
   hEff2->SetBinError(2,0.001246252);
   hEff2->SetBinError(3,0.003651269);
   hEff2->SetBinError(4,0.004698056);
   hEff2->SetBinError(5,0.005916202);
   hEff2->SetEntries(3771.084);
   hEff2->SetStats(0);
